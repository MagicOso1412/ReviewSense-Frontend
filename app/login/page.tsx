          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl dark:shadow-2xl p-8 sm:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-gray-300 dark:border-gray-700 text-amber-600 focus:ring-amber-500 cursor-pointer"
                  />
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Recuérdame</span>
                </label>
                <a href="#" className="text-sm font-medium text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 transition">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400">O continúa con</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full py-3 px-4 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white font-semibold hover:bg-gray-100 dark:hover:bg-gray-700 transition flex items-center justify-center gap-2"
              >
